//恩布在线客服访问域名
var eb900url ="http://onlinecall.entboost.com";
...
document.writeln('<link href="' + eb900url + '/css/support_list.css" rel="stylesheet" type="text/css" />');
...
if( navigator.userAgent.toLowerCase().match(/msie ([\d.]+)/) ) {
	document.writeln('      	<img onclick="openEBHOMEWin()" class="sp-logo" src="' + eb900url + '/images2/s-logo.gif"/>');
} else {
	document.writeln('      	<img onclick="openEBHOMEWin()" class="sp-logo" src="' + eb900url + '/images2/logo.gif"/>');
}
document.writeln('      	<div class="sp-title1 yahei"><span>恩布在线客服</span></div>');
document.writeln('		</div>');
document.writeln(' 		<div class="sp-btn yahei" onclick ="openEB900Win(\'' + eb900url + '/client.html?v=1&to_account=' + eb_to_account +'\');"><span>在线咨询</span></div>');
document.writeln('		<div class="sp-tel yahei"><span>电话&nbsp;0755-27362216</span></div>');
document.writeln('	</div>');
document.writeln('</div>');
